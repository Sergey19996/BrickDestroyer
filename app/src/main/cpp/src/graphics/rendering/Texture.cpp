...
Texture::Texture() : Width(0),Height(0),Internal_Format(GL_RGBA),Image_Format(GL_RGBA),Wrap_S(GL_REPEAT),Wrap_T(GL_REPEAT),Filter_Max(GL_LINEAR),Filter_Min(GL_LINEAR_MIPMAP_LINEAR)
{
